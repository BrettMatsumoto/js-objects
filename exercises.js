...
author: ["Darius Hinks", 'Cawkwell', 'Ben Counter'],
category: 'Epic Novel',
pages: 795
};
console.log(books);
...
plainBox.size = 20;
plainBox.contents = ['Hopes', 'Dreams'];
 ...
 */
 ...
 var completePerson = (buildPerson(plainPerson, 'Brett', 26));
 console.log(buildPerson(plainPerson, 'Brett', 26));
...
function putInPlainBox(object){
    for (i=0;i<10;i++){
        ...
        object.contents.push(randomNumbers);
    } return object
}
...
function detectingTransmission(object){
    if (object.isAutomaticTransmission === true){
        return 'Has automatic transmission'
    } else {
        return 'Does not have automatic transmission'
    }
}
